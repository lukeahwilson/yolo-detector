...
# PURPOSE:
#   - An exercise to build a yolov3 detector class from the open source config file from scratch
#   - Worked through the notes, and learned and disected each line of code as shared from the educational linked blog
##
